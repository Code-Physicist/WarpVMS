              ...
              <div class="bg-white rounded-3 p-4">
                <div class="login-form x-login-form">
                  <a class="mb-4 d-flex align-items-center justify-content-between">
                    ...
                    <h3 v-show="true" class="h4-login-form my-0 pe-2" style="display:none;">Reset</h3>
                  </a>
                  ...
                  <div class="d-grid py-3 mt-3">
                    <button type="button" @click="submit" class="btn btn-lg btn-primary">
                      SEND
                    </button>
                  </div>
                </div>
      ...
      const app = createApp({
          ...
          methods: {
            async submit() {
              ...
              try {
                response = await axios.post("/admin/reset_passwrd", this.user);

                let data = response.data;
                if(data.status === "I")
                  this.form_message = "Invalid or expired request";
